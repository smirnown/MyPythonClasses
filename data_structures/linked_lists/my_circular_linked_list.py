"""This module contains my custom circular linked list class."""

from my_linked_list import MyNode


class MyCircularLinkedList:
    """"This is my attempt to code a circular linked list."""
    ...
    def add(
        ...
        """Adds a new node to the end of the circular linked list (i.e. last_node)."""
    ...
    def __insert_node_in_middle(
        ...
        """Inserts a new node anywhere after the beginning and before the end of a circular linked list."""
    ...
    def exists(
        ...
        """Checks if the specified value is stored anywhere in the circular linked list."""
        size_of_list = self.size()
        index = 0
    ...
    def __delete_first_node(
        ...
        """Deletes the first node in the circular linked list."""
    ...
    def __delete_node_in_middle(
        ...
        """Deletes a node in the middle of the circular linked list."""
    ...
    def __delete_last_node(
        ...
        """Deletes the last node in the circular linked list."""
        size_of_list = self.size()
